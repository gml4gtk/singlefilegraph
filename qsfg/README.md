...
**QSFG** is a multiplatform graph editor written in C++/Qt based on ** QSVGE** version 0.6.3
...
make  
or  
scan-build -v -v -maxloop 300 --force-analyze-debug-code make  
in directory bin is the program qsfgapp  
make clean  
make distclean  
  
To add feature to run graphviz dot layout program uncomment this line in src/config.pri like this  
CONFIG += USE_GVGRAPH  
